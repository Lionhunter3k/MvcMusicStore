...
namespace MvcMusicStore.Infrastructure.Logging
{
    public class LoggingFacility : AbstractFacility
    {
        ...
        public LoggingFacility(LoggerImplementation loggingApi)
        ...
        public LoggingFacility(LoggerImplementation loggingApi, string configFile)
            : this(loggingApi, null, configFile)
        {
        }
