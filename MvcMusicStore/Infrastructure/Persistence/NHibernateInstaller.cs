...
namespace MvcMusicStore.Infrastructure.Persistence
{
    public class NHibernateInstaller : IWindsorInstaller
    {
        ...
        public void Install(Castle.Windsor.IWindsorContainer container, Castle.MicroKernel.SubSystems.Configuration.IConfigurationStore store)
        {
            ...
            container.AddFacility<NHibernateLocalSQLiteDebugFacility>();
            container.Register(Component.For<StatefulSessionWrapper>().LifestyleTransient(),
                    Component.For<StatelessSessionWrapper>().LifestyleTransient());
